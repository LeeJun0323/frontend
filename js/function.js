...
// console.log(myFunc3(12, 6)); //ReferenceError: Cannot access 'myFunc3' before initialization
...
// array2에서 20보다 큰 요소 찾기(첫번째 요소만 돌려줌)
...
const result3 = array2.filter((x) => x > 20);
console.log(result3);
...
console.log(decodeURI("http://localhost:8080/basic/info.html?name=홍길동"));
